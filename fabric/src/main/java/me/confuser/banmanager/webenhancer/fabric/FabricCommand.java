...
import me.confuser.banmanager.fabric.FabricSender;
...
public class FabricCommand {
    ...
    private CommonSender getSender(ServerCommandSource source) {
        if (source.getEntity() instanceof ServerPlayerEntity) {
            return new FabricPlayer((ServerPlayerEntity) source.getEntity(), source.getServer(),
                BanManagerPlugin.getInstance().getConfig().isOnlineMode());
        } else {
